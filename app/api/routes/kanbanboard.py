...
from app.db_models.crud.kanbanboard import CRUDKanbanBoard
from app.db_models.crud.kanbanstatus import CRUDKanbanStatus
...
def create_kanban_board(kanban_board: KanbanBoardCreate, db: Session = Depends(get_db)):
    kanban_board_crud = CRUDKanbanBoard(db)
